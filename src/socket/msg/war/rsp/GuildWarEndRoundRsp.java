...
public class GuildWarEndRoundRsp extends socket.msg.basic.Respond {

    public int round;

    public GuildWarEndRoundRsp(User user) {
        super(user);
    ...
    protected void readFromBuffer(ByteArray buff, int limit) {
        ...
        while (buff.remaining() > limit) {
            ...
            switch (_loc_4 >> 3) {
                case 1: {
                    if (_loc_3 != 0) {
                        show("Bad data format: GuildWarEndRoundRsp.round cannot be set twice.");
                    }
                    _loc_3 = _loc_3 + 1;

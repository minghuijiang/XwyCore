...
public class AllMsg2 {
	...
	public static String saveGroup(User user) {
		return user.send(
	...
	public static String cBattleLoad(User user) {
		return user.send(
			"&act=startfight&ctl=cfight",
			null
		);
	}
	...
	public static String equipUp(User user) {
		return user.send(
			"&act=upequip&ctl=item",
			null
		);
	}
	...
	public static String equipBatUp(User user) {
		return user.send(
			"&act=batchupequip&ctl=item",
			null
		);
	}
	...
	public static String equipSet(User user) {
		return user.send(
			"&act=setequip&ctl=rwarrior",
			null
		);
	}
	...
	public static String equipBeset(User user) {
		return user.send(
			"&act=setequipstone&ctl=item",
			null
		);
	}
	...
	public static String stoneCompose(User user) {
		return user.send(
	...
	public static String itemSell(User user) {
		return user.send(
			"&act=sellitem&ctl=item",
			null
		);
	}
	...
	public static String itemCompose(User user) {
		return user.send(
	...
	public static String itenOpen(User user) {
		return user.send(
			"&act=bagopenbox&ctl=item",
			null
		);
	}
	...
	public static String itemRbuff(User user) {
		return user.send(
			"&act=baguseitem&ctl=item",
			null
		);
	}
	...
	public static String equipSoulCreate(User user) {
		return user.send(
			"&act=createsoul&ctl=item",
			null
		);
	}
	...
	public static String equipSoulSave(User user) {
		return user.send(
			"&act=dochangeproperty&ctl=item",
			null
		);
	}
	...
	public static String equipSoulPrepChg(User user) {
		return user.send(
			"&act=changeproperty&ctl=item",
			null
		);
	}
	...
	public static String equipIdentify(User user) {
		return user.send(
			"&act=identifyequip&ctl=item",
			null
		);
	}
	...
	public static String questFinish(User user) {
		return user.send(
	...
	//AcceptQuestProxy.as: line 25: 	App.net.send(new HttpGetParams(PHPConsts.QUEST_ACCEPT).getHttpString(), {questcfgid:_loc_3.questcfgid, rwarriorid:this._npc.id}, this.acceptSuccess, this.acceptFailure);
	//{"rep":"object","_cls":"msg","msgident":"0001","msg":"_gam_err_noquestcfgid"}

	public static String questAccept(User user) {
		return user.send(
			"&act=accept&ctl=rquest",
			null
		);
	}
	...
	public static String skillSet(User user) {
		return user.send(
			"&act=setrwskill&ctl=rwarrior",
			null
		);
	}
	...
	public static String interUp(User user) {
		return user.send(
	...
	public static String interShare(User user) {
		return user.send(
	...
	public static String interLoopUp(User user) {
		return user.send(
	...
	//{"rep":"object","_cls":"msg","msgident":"0000","msg":"_gam_suc_rmaplist","data":{"_cls":"rmapList","rmapList":[{"_cls":"rmapVo","mapcfgid":"13","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1074,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1067","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1027","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10032,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5022","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":1019,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1047","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1097","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"35","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"128","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1108,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"22","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"106","iscleared":1,"cleartimes":3,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"134","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1080,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1009,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10024,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1066,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1093","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":5009,"iscleared":1,"cleartimes":51,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":1014,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5004","iscleared":1,"cleartimes":43,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"1054","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":110,"iscleared":1,"cleartimes":49,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":45,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"125","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"126","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1041","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5003","iscleared":1,"cleartimes":42,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"127","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"25","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5010","iscleared":1,"cleartimes":41,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":10021,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1035","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":5000,"iscleared":1,"cleartimes":38,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"118","iscleared":1,"cleartimes":42,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1033","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1008","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5021","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":8,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10002,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"139","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"18","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1020,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10010,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1050,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1023","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":130,"iscleared":1,"cleartimes":3,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":160,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5023","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"1091","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10026,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1024,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1079,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1004,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"122","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1106","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1034,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1046,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10025,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1056,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"129","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1006","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1001","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"124","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5019","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"1037","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":6,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":32,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1011","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1101","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"43","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1002","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5001","iscleared":1,"cleartimes":33,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"21","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":33,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1015","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1052,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1068","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"41","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10028,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1057","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1092,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1061","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10001,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":10029,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1069,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10020,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1072,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1076,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":100,"iscleared":1,"cleartimes":5,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1043","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1051","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1026,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"96","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5005","iscleared":1,"cleartimes":41,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"5015","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"102","iscleared":1,"cleartimes":5,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1090,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1028","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1042,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"123","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":29,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1045","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1078,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":24,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"113","iscleared":1,"cleartimes":46,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1025","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1098","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1007","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"161","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"114","iscleared":1,"cleartimes":46,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5008","iscleared":1,"cleartimes":44,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":16,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":20,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":15,"iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1013","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1048,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1016,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10023,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"131","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"95","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"27","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5013","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"5016","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":10009,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":10022,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1039,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"121","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1062,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"135","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1040,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1032,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1031","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"103","iscleared":1,"cleartimes":4,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1064,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"162","iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1038,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5018","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"1005","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"104","iscleared":1,"cleartimes":4,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"133","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10008,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"117","iscleared":1,"cleartimes":44,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":3,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":31,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"34","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5011","iscleared":1,"cleartimes":42,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"93","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5002","iscleared":1,"cleartimes":30,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":4,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10018,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5014","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"1095","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10011,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":10014,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1070,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"99","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"132","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1103","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1055","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5006","iscleared":1,"cleartimes":43,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":10003,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"136","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"109","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":38,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":40,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1104,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10012,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":10000,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1073","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1094,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10017,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"105","iscleared":1,"cleartimes":3,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5017","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":23,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1060,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1030,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":5024,"iscleared":0,"cleartimes":"0","isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":10016,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1063","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1021","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1071","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1029","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1105","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"14","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"138","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1109,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"108","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10015,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1099,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"97","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10019,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"91","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":120,"iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1010,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1022,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":5,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":7,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"37","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1058","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":42,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1000,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1065","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10004,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"137","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"17","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":5012,"iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"19","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"101","iscleared":1,"cleartimes":5,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"115","iscleared":1,"cleartimes":46,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":9,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":12,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1107","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"44","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1003","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10005,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1059,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1077","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1036","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":36,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1017","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1012,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10006,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1100,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"39","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"94","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":26,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"98","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":11,"iscleared":1,"cleartimes":3,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":140,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":10007,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":1044,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"112","iscleared":1,"cleartimes":47,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"2","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5007","iscleared":1,"cleartimes":42,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":90,"iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1053","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":30,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1049","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"92","iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":1096,"iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"107","iscleared":1,"cleartimes":3,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10033,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1018","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"116","iscleared":1,"cleartimes":45,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1075","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"5020","iscleared":1,"cleartimes":1,"isopen":"1","dayfighted":0},{"_cls":"rmapVo","mapcfgid":"1","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"1102","iscleared":1,"cleartimes":1,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":28,"iscleared":1,"cleartimes":2,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":10013,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":10027,"iscleared":0,"cleartimes":"0","isopen":"1"},{"_cls":"rmapVo","mapcfgid":"119","iscleared":1,"cleartimes":42,"isopen":"1"},{"_cls":"rmapVo","mapcfgid":"111","iscleared":1,"cleartimes":48,"isopen":"1"}]}}
	...
	public static String treeBless(User user) {
		return user.send(
	...
	//{"rep":"object","_cls":"msg","msgident":"0000","msg":"_gam_suc_getstamina","change":{"_cls":"changeObj","role":{"805493":{"stamina":48,"nowstamina":"78","laststaminatime":1405787408}},"rwarrior":null,"rwarriorskill":null,"rwarriorskillbuff":null,"rbagitem":null,"rbuild":null,"rquest":null,"rmap":null,"rwarriorinpub":null,"rwarriorgroup":null,"roperator":null}}

	public static String getStamina(User user) {
		return user.send(
			"&act=getstamina&ctl=game",
			null
		);
	}
	...
	//{"rep":"object","_cls":"msg","msgident":"0000","msg":"_gam_suc_addstamina","change":{"_cls":"changeObj","role":{"805493":{"gamepoint":"114","nowstamina":"83","laststaminatime":1405787409,"buystaminatimes":"1","qliveness":"60"}},"rwarrior":null,"rwarriorskill":null,"rwarriorskillbuff":null,"rbagitem":null,"rbuild":null,"rquest":{"73":{"gotnum":5,"gotaward":1}},"rmap":null,"rwarriorinpub":null,"rwarriorgroup":null,"roperator":null}}

	public static String addStamina(User user) {
		return user.send(
			"&act=addstamina&ctl=game",
			null
		);
	}
	...
	public static String trainCommit(User user) {
		return user.send(
	...
	public static String trainClear(User user) {
		return user.send(
	...
	public static String trainClickBubble(User user) {
		return user.send(
			"&act=hitbubble&ctl=train",
			null
		);
	}
	...
	public static String barWarriorRecurit(User user) {
		return user.send(
			"&act=recruitwarrior&ctl=inpub",
			null
		);
	}
	...
	public static String barBatNpc(User user) {
		return user.send(
			"&act=playwarrior&ctl=inpub",
			null
		);
	}
	...
	public static String tradeCreate(User user) {
		return user.send(
	...
	public static String tradeViewResult(User user) {
		return user.send(
	...
	public static String tradeGain(User user) {
		return user.send(
	...
	public static String tavernSendGift(User user) {
		return user.send(
			"&act=sendpresent&ctl=hotel",
			null
		);
	}
	...
	public static String tavernChatWithNpc(User user) {
		return user.send(
			"&act=talkwarrior&ctl=hotel",
			null
		);
	}
	...
	public static String tavernLearnSkill(User user) {
		return user.send(
	...
	public static String tavernBatSendGift(User user) {
		return user.send(
	...
	public static String inviteInGameFriend(User user) {
		return user.send(
	...
	public static String friendCheck(User user) {
		return user.send(
	...
	public static String deleteFriend(User user) {
		return user.send(
	...
	public static String startArenav2(User user) {
		return user.send(
	...
	public static String arenaWorshipv2(User user) {
		return user.send(
	...
	public static String workerCatch(User user) {
		return user.send(
	...
	public static String workerAssign(User user) {
		return user.send(
	...
	public static String workerGain(User user) {
		return user.send(
	...
	public static String workerLiberate(User user) {
		return user.send(
	...
	public static String workerGetmaster(User user) {
		return user.send(
	...
	public static String workerFlight(User user) {
		return user.send(
	...
	public static String workerFlightApply(User user) {
		return user.send(
	...
	public static String farmDoPlant(User user) {
		return user.send(
	...
	public static String farmPickPlant(User user) {
		return user.send(
	...
	public static String farmWaterPlant(User user) {
		return user.send(
	...
	public static String farmCutPlant(User user) {
		return user.send(
	...
	public static String farmUpField(User user) {
		return user.send(
	...
	public static String farmBatWater(User user) {
		return user.send(
	...
	public static String farmUnlockSkin(User user) {
		return user.send(
	...
	public static String farmFitment(User user) {
		return user.send(
	...
	public static String transportStartrob(User user) {
		return user.send(
	...
	public static String getTowerauto(User user) {
		return user.send(
	...
	public static String towerReset(User user) {
		return user.send(
	...
	//TowerProxy.as: line 68: 	App.net.send(new HttpGetParams(PHPConsts.EXCHANGE_ALL).getHttpString(), {changeid:event.data, type:ExChangeType.TOWER_TYPE}, this.changeComplete);
	//{"rep":"object","_cls":"msg","msgident":"0002","msg":"_gam_err_paramerr"}

	public static String exchangeAll(User user) {
		return user.send(
	...
	public static String transferCofirm(User user) {
		return user.send(
	...
	public static String mapRaids(User user) {
		return user.send(
	...
	public static String startMatch(User user) {
		return user.send(
	...
	public static String rankHistorygroup(User user) {
		return user.send(
	...
	public static String openSignBox(User user) {
		return user.send(
	...
	public static String getInviteAward(User user) {
		return user.send(
	...
	public static String inviteFriends(User user) {
		return user.send(
	...
	public static String dayInviteFriend(User user) {
		return user.send(
	...
	//{"rep":"object","_cls":"msg","msgident":"0000","msg":"_gam_suc_getnewsok","data":{"newsList":{"1":{"order":1,"content":"1111"},"2":{"order":2,"content":"2222"},"4":{"order":4,"content":"3333"},"10":{"order":10,"content":"3333"}},"_cls":"getNews"}}
	...
	public static String buyGoods(User user) {
		return user.send(
	...
	public static String getShopinfo(User user) {
		return user.send(
	...
	public static String sendYellowvipaward(User user) {
		return user.send(
	...
	//{"rep":"object","_cls":"msg","msgident":"0000","msg":"_gam_suc_getoperatortokenok","data":{"actid":"UM121227132754657","mid":"1","token":"4021A324754CCD7EA01836261D0AFF7207622","_cls":"getOperatorToken"}}
	...
	public static String fixLion(User user) {
		return user.send(
	...
	public static String levelSpecialRecord(User user) {
		return user.send(
	...
	public static String fundsBuy(User user) {
		return user.send(
	...
	public static String fundsGain(User user) {
		return user.send(
	...
	public static String eventDaillottery(User user) {
		return user.send(
	...
	public static String cardreward(User user) {
		return user.send(
	...
	public static String mayDayRecharge(User user) {
		return user.send(
	...
	public static String exchangeHero(User user) {
		return user.send(
	...
	public static String buyHero(User user) {
		return user.send(
	...
	public static String heroPill(User user) {
		return user.send(
	...
	//ActivityPublicEvent.as: line 89: 	App.net.send(new HttpGetParams(PHPConsts.EVENT_PUBLIC_CONFIG).getHttpString(), {eventid:_data.id}, this.loadCfgComplete);
	//{"rep":"object","_cls":"msg","msgident":"0002","msg":"_opconf_err_opconfcfgnotexist"}

	public static String eventPublicConfig(User user) {
		return user.send(
	...
	public static String eventPublicInit(User user) {
		return user.send(
			"&act=init&ctl=opconf",
			null
		);
	...
	public static String eventPublicGetreward(User user) {
		return user.send(
	...
	public static String getHerondFight(User user) {
		return user.send(
	...
	public static String rankWarrior(User user) {
		return user.send(
	...
	public static String rankGetaward(User user) {
		return user.send(
	...
	public static String valentinesend(User user) {
		return user.send(
	...
	public static String techUpgrade(User user) {
		return user.send(
	...
	public static String getRmsglist(User user) {
		return user.send(
	...
	public static String getRmsgstate(User user) {
		return user.send(
			"&act=uprmsg&ctl=rmsg",
			null
		);
	...
	public static String raidEliteboss(User user) {
		return user.send(
	...
	public static String userGift(User user) {
		return user.send(
	...
	public static String equipArti(User user) {
		return user.send(
	...
	public static String upgreatArti(User user) {
		return user.send(
	...
	public static String talismanBeset(User user) {
		return user.send(
	...
	public static String talismanLevelup(User user) {
		return user.send(
	...
	public static String buySecretgood(User user) {
		return user.send(
	...
	public static String guildCreate(User user) {
		return user.send(
	...
	public static String guildApply(User user) {
		return user.send(
	...
	public static String guildInfoCheck(User user) {
		return user.send(
	...
	public static String startFate(User user) {
		return user.send(
	...
	public static String fateExchange(User user) {
		return user.send(
	...
	public static String equipFate(User user) {
		return user.send(
	...
	public static String upgradeFate(User user) {
		return user.send(
	...
	public static String guildApplyDeal(User user) {
		return user.send(
	...
	public static String guildGetLog(User user) {
		return user.send(
	...
	public static String guildInfoSet(User user) {
		return user.send(
	...
	public static String guildCreatorOperate(User user) {
		return user.send(
	...
	public static String guildMemberOperate(User user) {
		return user.send(
	...
	public static String guildMallPlaydial(User user) {
		return user.send(
	...
	public static String guildTechOp(User user) {
		return user.send(
	...
	public static String guildSpaDonate(User user) {
		return user.send(
	...
	public static String skinUnlock(User user) {
		return user.send(
	...
	public static String skinDress(User user) {
		return user.send(
	...
	public static String getChargeData(User user) {
		return user.send(
	...
	public static String getChargeAward(User user) {
		return user.send(
	...
	public static String operateFreegift(User user) {
		return user.send(
	...
	public static String petRname(User user) {
		return user.send(
	...
	public static String petTrain(User user) {
		return user.send(
	...
	public static String petFeed(User user) {
		return user.send(
	...
	public static String petActiveSkill(User user) {
		return user.send(
	...
	public static String petAddFire(User user) {
		return user.send(
	...
	public static String petVisitFriend(User user) {
		return user.send(
	...
	public static String stoveAcc(User user) {
		return user.send(
	...
	public static String buyFinance(User user) {
		return user.send(
	...
	public static String buyLevelfund(User user) {
		return user.send(
	...
	public static String guildfightStartbet(User user) {
		return user.send(
	...
	public static String changeskinInit(User user) {
		return user.send(
	...
	public static String changeskinCultivate(User user) {
		return user.send(
	...
	public static String changeskinInherit(User user) {
		return user.send(
	...
	public static String achieveTest(User user) {
		return user.send(
	...
	public static String achieveChangetitle(User user) {
		return user.send(
	...
	public static String achieveGetaward(User user) {
		return user.send(
